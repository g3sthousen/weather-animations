...
const cfgA: ResolvedConfig = { condition: 'clear', intensity: 'medium', time: 'day', transitionMs: 1000 };
const cfgB: ResolvedConfig = { condition: 'rain', intensity: 'heavy', time: 'night', transitionMs: 1000 };
